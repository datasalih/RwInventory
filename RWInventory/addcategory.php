...
if(isset($_POST["add_category"]))
{
    ...
    if(isset($category_name))
    {
        ...
        $insert = "INSERT INTO categories (category_name, company_id) VALUES ('$category_name', '$company_id')";
...
<body>
  ...
  <form action="addcategory.php" method="POST">
    ...
    <input type="text" id="product-name" name="category_name" required><br><br>
